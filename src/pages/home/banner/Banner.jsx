...
<div className="container mx-auto px-6">
          <div className="flex justify-center">
            ...
            <button className="text-primary bg-primary/10 font-medium py-1 px-2 rounded"> Welcome to Fresh Harvest</button>
           <h1 className="font-Rubik font-medium text-[80px] leading-none lg:my-6">Fresh Fruits and Vegetables</h1>
           ...
           <div className="bg-gray-200 py-4 rounded-xl flex justify-between items-center px-4 ml-60 mr-8 mt-8">
              <div className="pl-2 space-y-2">
              <p className="font-Rubik text-primary">Special Offer</p>
              <h4 className="text-xl font-Rubik font-semibold">Fresh Salad</h4>
              <h5 className="font-Rubik font-semibold"> <span className="text-primary">Up to</span> <span className="border border-red-400 rounded-full">70%</span> off</h5>
              <button className="bg-primary text-white font-bold uppercase rounded-full py-2 px-4">code: <span className="text-red-400">fresh25</span></button>
              </div>
              <div>
